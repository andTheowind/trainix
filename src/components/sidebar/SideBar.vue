...
<template>
    <div class="flex flex-col min-w-fit gap-x-3 gap-y-4 mt-5 text-[#8D8BA2]">
        <a @click="handleClick('Главная')"
            :class="['flex', 'justify-start', 'cursor-pointer', { 'text-[#7AB0FF]': currentWindow === 'Главная' }]">
            <IconSet name="home" :color="currentWindow === 'Главная' ? '#7AB0FF' : '#8D8BA2'" />
            <span class="block ps-3">Главная</span>
        </a>
        <a @click="handleClick('Профиль')"
            :class="['flex', 'justify-start', 'cursor-pointer', { 'text-[#7AB0FF]': currentWindow === 'Профиль' }]">
        ...
        <a @click="handleClick('Поиск тренера')"
            :class="['flex', 'justify-start', 'cursor-pointer', { 'text-[#7AB0FF]': currentWindow === 'Поиск тренера' }]">
        ...
        <a @click="handleClick('Мои настройки')"
            :class="['flex', 'justify-start', 'cursor-pointer', { 'text-[#7AB0FF]': currentWindow === 'Мои настройки' }]">
        ...
        <a @click="handleClick('Поддержка')"
            :class="['flex', 'justify-start', 'cursor-pointer', { 'text-[#7AB0FF]': currentWindow === 'Поддержка' }]">
